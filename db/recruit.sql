...
`user` varchar(25) DEFAULT NULL COMMENT '用户名',
...
`birthYear` int DEFAULT NULL COMMENT '出生年份',
`graduation` varchar(25) DEFAULT NULL COMMENT '毕业院校',
`eduDegree` varchar(25) DEFAULT NULL COMMENT '学历',
`major` varchar(25) DEFAULT NULL COMMENT '专业',
`graduateYear` int DEFAULT NULL COMMENT '毕业年份',
`dirDesire` float DEFAULT NULL COMMENT '期望薪资',
